...
**发送到中书省 webhook：**
`https://open.feishu.cn/open-apis/bot/v2/hook/c03400f7-5ce5-4205-acfe-a6959e418d7e`

### 起草方案通知太子（爸）
```bash
curl -s -X POST "https://open.feishu.cn/open-apis/bot/v2/hook/c03400f7-5ce5-4205-acfe-a6959e418d7e" \
  -H "Content-Type: application/json" \
  -d '{"msg_type":"text","content":{"text":"✍️ 中书省起草方案：<任务ID>\n方案概要：<一句话说明>\n已提交门下省审议" }}'
```
